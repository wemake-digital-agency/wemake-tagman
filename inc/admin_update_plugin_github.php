...
if (!class_exists('Wemake_Tagman_GitHub_Updater')) {

    class Wemake_Tagman_GitHub_Updater
    {

        private $plugin_file;
        private $plugin_slug;
        private $github_repo = 'wemake-digital-agency/wemake-tagman';
        private $github_api_url = 'https://api.github.com/repos/wemake-digital-agency/wemake-tagman/releases/latest';
    ...
    add_action('admin_init', function () {
        new Wemake_Tagman_GitHub_Updater(wmtm_get_plugin_row_path());
    });
}
?>
